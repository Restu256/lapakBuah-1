                        ...
                        <div class="box bg-white rounded shadow-sm p-3">
                            <div class="box-header">
                                <div class="box-title w-100 d-flex flex-row justify-content-between">
                                    ...
                                    @can('route-list')
                                        <a class="btn btn-success" href="{{ route('routes.index') }}"><i class="fa fa-reply" aria-hidden="true"></i> Back</a>
                                    @endcan
                                </div>
                            </div>
                            <hr>
                            <div class="box-body mt-3">
                                {!! Form::model($permission, ['method' => 'PATCH','route' => ['routes.update', $permission->id]]) !!}
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong>Name:</strong>
                                            {!! Form::text('name', null, array('placeholder' => 'Name','class' => 'form-control','value'=>"{{ $permission->name }}")) !!}
                                        </div>
                                    </div>
