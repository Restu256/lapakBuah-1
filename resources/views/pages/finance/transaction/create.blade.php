                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_transaksi" id="no_transaksi" class="form-control" value="1000{{ $pembelian+1 }}">
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#saveBtnMetode').click(function (e) {
            ...
            url: "{{ route('storeAjaxMetodePembelian') }}",
            type: "POST",
            dataType: 'json',
            success: function (data) {
    ...
    $(function (){
        ...
        $('#saveBtnSyarat').click(function (e){
            ...
            $.ajax({
                ...
                url: "{{ route('storeAjaxSyaratPembelian') }}",
                type: "POST",
                dataType: "JSON",
                success: function(data){
