                    ...
                    <div class="col-md-12">
                        <div class="box bg-white rounded shadow-sm p-3">
                            <div class="box-header">
                                ...
                                <a class="btn btn-success" href="{{ route('imageblog.create') }}"> Add Category</a>
                            </div>
                            <hr>
                            <div class="box-body mt-3">
                                   ...
                                   <tr>
                                     ...
                                     <td>
                                        ...
                                        <a class="btn btn-primary" href="{{ route('imageblog.edit',$image->id) }}">Edit</a>
                                        <a class="btn btn-danger" href="{{ route('imageblog.destroy',$image->id) }}">Hapus</a>
                                     </td>
                                   </tr>
                                  @endforeach
